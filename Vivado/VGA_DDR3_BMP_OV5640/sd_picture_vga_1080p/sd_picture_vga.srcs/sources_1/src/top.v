...
wire                             clk_148_5M;             //clock for 1920*1080@60Hz VGA display
...
assign                          video_clk = clk_148_5M; //选择当前分辨率对应的时钟
...
(
    ...
    .bmp_width                      (16'd1920                 ),        //image width
    .write_req                      (write_req                ),
...
/*************************************************************************
VGA 1920*1080@60Hz timing control and data generation module
****************************************************************************/
vga_timing_data_1920 vga_timing_data_1920_m0
(
...
(
    ...
    .read_len                       (25'd1036800              ), //frame size 1920 * 1080 * 32 / 64
    .read_en                        (read_en                  ),
    .read_data                      (read_data                ),
    ...
    .write_len                      (25'd1036800              ), //frame size
    .write_en                       (write_en                 ),
    .write_data                     (write_data               )
);
/*************************************************************************
